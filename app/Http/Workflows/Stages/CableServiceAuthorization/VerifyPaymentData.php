...
namespace App\Http\Workflows\Stages\CableServiceAuthorization;

use App\Http\Workflows\Stage;
use App\Models\User;
use App\Models\WorkflowRequest;

class VerifyPaymentData implements Stage
{
    ...
    public function process(): void
    {
        ...
        redirect()->route('cable-service-authorization.verify-payment-data', $this->workflowRequest->key);
    }

    public function complete(): void
    {
        $this->workflowRequest->state = 2;
