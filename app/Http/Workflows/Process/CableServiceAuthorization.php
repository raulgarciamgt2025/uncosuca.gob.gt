...
use App\Http\Workflows\Stages\CableServiceAuthorization\UserPaymentData;
use App\Http\Workflows\Stages\CableServiceAuthorization\PaySlipUpload;
use App\Http\Workflows\Stages\CableServiceAuthorization\VerifyPaymentData;
...
class CableServiceAuthorization extends Workflow
{
    ...
    public function setStages(): void
    {
        $this->stages = [
            ...
            new PaySlipUpload($this->workflowRequest),
            new UserPaymentData($this->workflowRequest),
            new VerifyPaymentData($this->workflowRequest),
        ];
    }
}
