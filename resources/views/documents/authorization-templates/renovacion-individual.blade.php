...
<p class="justify">
    ...
    en la ley y, tomando en consideración los antecedentes del presente expediente es procedente renovar la licencia,
    promovida por {{ $fields['owner_name'] }}, PROPIETARIO O COPROPIETARIOS de la empresa
    mercantil {{ $fields['mercantile_company_name'] }}.
</p>
<p class="justify">
...
<p class="justify black-text">
    DECLARA: I. CON LUGAR, LA RENOVACIÓN DE LICENCIA, PROMOVIDA POR {{ mb_strtoupper($fields['owner_name']) }},
