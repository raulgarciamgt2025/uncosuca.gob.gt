<div class="card p-2">
    <h2 class="card-title px-4">
        <strong>Autorización de firma jurídica - {{ $this->workflowRequest->workflow->name }} {{ $this->workflowRequest->process_type ?
    ...
    <x-modal wire:model="modal_reject" maxWidth="lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">REGRESAR EXPEDIENTE A LA ETAPA ANTERIOR</h5>
                <button
                    type="button"
                    class="btn"
